...
class __$$_FetchedCopyWithImpl<$Res>
    extends _$WeatherStateCopyWithImpl<$Res, _$_Fetched>
...
class _$_Fetched implements _Fetched {
  const _$_Fetched({required this.weatherModel});
  ...
  @override
  String toString() {
    return 'WeatherState.fetched(weatherModel: $weatherModel)';
  }
...
abstract class _Fetched implements WeatherState {
  const factory _Fetched({required final WeatherModel weatherModel}) =
      _$_Fetched;
